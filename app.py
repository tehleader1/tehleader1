...
<div id="srd-cart-drawer">
  ...
  <div class="srd-cart-head">
    <div class="srd-cart-title">Your Cart</div>
    <span class="srd-cart-count" id="srd-cart-count">0</span>
    <button class="srd-cart-close" onclick="srdCloseCart()">✕</button>
  </div>
  <div class="srd-cart-items" id="srd-cart-items">
    <div class="srd-cart-empty">Your cart is empty</div>
  </div>
  <div class="srd-cart-footer">
    <div class="srd-cart-total-row">
      <div class="srd-cart-total-label">Total</div>
      <div class="srd-cart-total-amt" id="srd-cart-total">$0.00</div>
    </div>
    <button class="srd-cart-checkout-btn" id="srd-cart-checkout-btn" onclick="srdCheckout()">Checkout →</button>
    <a class="srd-cart-shop-link" href="https://supportrd.com/collections/all" target="_blank">Browse all products</a>
  </div>
</div>
...
fetch('/api/me', {{credentials:'include',headers:{{'X-Auth-Token':localStorage.getItem('srd_token')||localStorage.getItem('aria_token')||''}}}})
