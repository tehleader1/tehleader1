...
const AI_LINKS = {
  dan_martell: "https://www.youtube.com/results?search_query=Dan%20Martell%20AI%20business",
  ai_millionaire: "https://www.youtube.com/results?search_query=AI%20making%20millionaires",
  ai_saas: "https://www.youtube.com/results?search_query=AI%20SaaS%20case%20study",
  best_ai_2026: "https://www.youtube.com/results?search_query=best%20AI%20tools%202026",
  agent_workflows: "https://www.youtube.com/results?search_query=AI%20agent%20workflows",
  automation_agency: "https://www.youtube.com/results?search_query=AI%20automation%20agency",
  ai_2026: "https://www.youtube.com/results?search_query=AI%202026%20technology%20advances",
  ai_research: "https://www.youtube.com/results?search_query=AI%20research%20breakthroughs%202026",
  future_jobs: "https://www.youtube.com/results?search_query=AI%20jobs%20income%20opportunities",
  ai_agency: "https://www.youtube.com/results?search_query=AI%20agency%20blueprint",
  ai_saas_builder: "https://www.youtube.com/results?search_query=AI%20SaaS%20builder",
  ai_consulting: "https://www.youtube.com/results?search_query=AI%20consulting%20offers"
}
...
function setupSEOLogs(){
  ...
  if(autoBtn){
    autoBtn.addEventListener("click", async ()=>{
      ...
      const ok = await setSeoAuto(enabled, stream)
      if(ok){
...
function setupAIMillionaireTab(){
  const reelBtn = qs("#aiOpenReel")
  if(reelBtn){ reelBtn.addEventListener("click", ()=>openModal("reelModal")) }
  ...
  if(name === "AI Millionaire Hub"){
    body.innerHTML = `
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:12px;">
        <button class="btn" id="aiHubReel">Open AI Millionaire TV</button>
    ...
    `
    qs("#aiHubReel").addEventListener("click", ()=>openModal("reelModal"))
